...
int MipsTest_PrintTrace(int argc, char* argv[]);
int MipsBacktraceTest_PrintTrace_02(int argc, char* argv[]);

/*====================main====================*/
int MipsBacktraceTest(int argc, char* argv[])
{
	int ret = 0;

//	ret = MipsBacktraceTest_backtrace(argc, argv);
//	ret = MipsBacktraceTest_Child(argc, argv);
	ret = MipsBacktraceTest_PrintTrace(argc, argv);
//	ret = MipsBacktraceTest_PrintTrace_02(argc, argv);

	return ret;
}

int MipsBacktraceTest_backtrace(int argc, char* argv[])
{
	if( argc<2 )
	{
...
int MipsBacktraceTest_Child(int argc, char* argv[])
{
...
int MipsBacktraceTest_PrintTrace(int argc, char* argv[])
{
	if (argc != 2)
	{
