...
int MipsBacktraceWhenRecvSIGSEGV_PrintStack(int argc, char *argv[]);

/*======================main======================*/
int MipsBacktraceWhenRecvSIGSEGV(int argc, char *argv[])
{
	int ret;

	ret = MipsBacktraceWhenRecvSIGSEGV_PrintStack(argc, argv);
...
#endif /* MIPSBACKTRACEWHENRECISIGSEGV_CPP */
/* end file */
