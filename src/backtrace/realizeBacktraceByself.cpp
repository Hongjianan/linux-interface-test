...
int RealizeBacktraceByself_01(int argc, char *argv[]);
int RealizeBacktraceByself_02(int argc, char *argv[]);

/*====================main=====================*/
int RealizeBacktraceByself(int argc, char *argv[])
{
	int ret;
...
#endif /* REALIZEBACKTRACEBYSELF_CPP */
/* end file */
